...
export default function useImagen() {
  ...
  // ============================================
  // FUNCIONES DE ESTADO (CRUD básico)
  // ============================================
  const resetImagen = () => {
  ...
  const getImagenes = async (params = {}) => {
    ...
    try {
      ...
      // Si tiene parámetros (Index.vue con paginación)
      if (Object.keys(params).length > 0) {
        ...
        // Sin parámetros (Upload.vue, simple list)
